...
public class LoginTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(".submit.signInBtn")));
		Thread.sleep(2000);
		//Entering details and Logging In
		...
		wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector("#chkboxOne"))));
